...
/* harmony export */   "NotationError": () => (/* binding */ NotationError)
/* harmony export */ });
...
var Glob = /*#__PURE__*/function () {
  ...
  _createClass(Glob, [{
    ...
    value: function toRegExp(glob) {
      ...
      g = _utils__WEBPACK_IMPORTED_MODULE_2__.utils.pregQuote(g)
    ...
    value: function compare(globA, globB) {
      ...
      if (a.notes.length === b.notes.length) {
        ...
        var aIdxCompare = _compareArrayItemGlobs(a, b);
    ...
    value: function normalize(globList) {
      ...
      function checkAddIntersection(gA, gB) {
        ...
        var hasInverted = restrictive ? false : original.indexOf(_invert(inter)) >= 0;
...
function _coversNote(a, b) {
  ...
  var bIsArr = re.ARRAY_GLOB_NOTE.test(b);
...
function _compareArrayItemGlobs(a, b) {
  var reANote = re.ARRAY_GLOB_NOTE;
  ...
  || !reANote.test(a.last) || !reANote.test(b.last)
  // last notes should be different to compare
  || a.last === b.last) return 0;
...
var reMATCHER = /(\[(\d+|".*"|'.*'|`.*`)\]|[a-z$_][a-z$_\d]*)/gi;
...
var Notation = /*#__PURE__*/function () {
  ...
  _createClass(Notation, [{
    ...
    value: function filter(globList) {
      ...
      var firstIsWildcard = re.WILDCARD.test(globs[0]);
      ...
      _utils__WEBPACK_IMPORTED_MODULE_2__.utils.each(globs, function (globNotation) {
        ...
        var glob = g.glob,
          ...
          levels = g.levels;
        var normalized, emptyValue, eType;
        ...
        if (re.WILDCARDS.test(normalized) === false) {
          if (isNegated) {
            ...
            var insRemove = filtered.inspectRemove(normalized);
            ...
            if (emptyValue) {
              ...
              var errMsg = errGlobIntegrity + "'".concat(vType, "'.");
              ...
              var isValSet = _utils__WEBPACK_IMPORTED_MODULE_2__.utils.isset(insRemove.value);
              ...
              var setMode = insRemove.parentIsArray ? 'insert' : 'overwrite';
        ...
        _each(_this3._source, function (originalNotation, key, value) {
          var originalIsCovered = _notation_glob__WEBPACK_IMPORTED_MODULE_0__.Glob.create(normalized).covers(originalNotation);
          ...
          if (_this3.options.strict && emptyValue) {
            ...
            var _vType = _utils__WEBPACK_IMPORTED_MODULE_2__.utils.type(value);
...
function _each(collection, callback) {
  ...
  var source = topSource || collection;
  ...
  _utils__WEBPACK_IMPORTED_MODULE_2__.utils.eachItem(collection, function (value, keyOrIndex) {
    ...
    var isCollection = _utils__WEBPACK_IMPORTED_MODULE_2__.utils.isCollection(value);
...
var utils = {
  ...
  cloneDeep: function cloneDeep(collection) {
    ...
    switch (t) {
      ...
      case 'symbol':
        ...
        /* istanbul ignore next */ : collection;
      case 'array':
  ...
  getNewNotation: function getNewNotation(newNotation, notation) {
    var errMsg = "Invalid new notation: '".concat(newNotation, "'");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Notation": () => (/* reexport safe */ _core_notation__WEBPACK_IMPORTED_MODULE_0__.Notation)
/* harmony export */ });
